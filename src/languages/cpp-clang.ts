export const lang = {
  ...
  compile: (sourcePath, outputDirectory, doNotUseX32Abi) => ({
    ...
    executable: "/usr/bin/clang++-12",
    parameters: ["clang++-12", sourcePath, "-o", `${outputDirectory}/a.out`, "-std=c++20", "-O2", "-lm", "-fdiagnostics-color=always", "-DONLINE_JUDGE", !doNotUseX32Abi && "-mx32"].filter(x => x),
    time: 10000,
